...
public class AppUtils {
    ...
    public static boolean installAppSilent(String filePath) {
        ...
        ShellUtils.CommandResult commandResult = ShellUtils.execCmd(command, !isSystemApp(TKBaseApplication.myApplication.getApplicationContext()), true);
    ...
    public static void launchApp(String packageName) {
        if (StringUtils.isSpace(packageName)) return;
        TKBaseApplication.myApplication.getApplicationContext().startActivity(IntentUtils.getLaunchAppIntent(packageName));
    }
     ...
     * @return
     */
    public static String getMetaDataValue(Context ctx, String metaDataKey) {
        if (ctx == null) {
            return null;
        }
