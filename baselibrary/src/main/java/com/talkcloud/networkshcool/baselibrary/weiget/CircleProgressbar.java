...
public class CircleProgressbar extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        if (typedArray.hasValue(R.styleable.CountDownView_ringColor)) {
            inCircleColors = typedArray.getColorStateList(R.styleable.CountDownView_progressTextColor);
        } else {
