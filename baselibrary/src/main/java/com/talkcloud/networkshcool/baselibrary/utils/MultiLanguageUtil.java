...
public class MultiLanguageUtil {
    ...
    public static void setConfiguration(Context context) {
        ...
        Locale locale = null;
        String spLanguage = MySPUtilsLanguage.getInstance().getLocaleLanguage();
        String spCountry = MySPUtilsLanguage.getInstance().getLocaleCountry();
        if (!StringUtils.isBlank(spLanguage) && !StringUtils.isBlank(spCountry)) {
    ...
    public static boolean isSameWithSetting(Context context) {
        ...
        String sp_language = MySPUtilsLanguage.getInstance().getLocaleLanguage();
        String sp_country = MySPUtilsLanguage.getInstance().getLocaleCountry();
