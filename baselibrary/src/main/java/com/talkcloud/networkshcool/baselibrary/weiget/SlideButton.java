...
public class SlideButton extends View {
    ...
    //椭圆的边框宽度
    private static final int strokeLineWidth = 1;
    //圆的边框宽度
    private static final int circleStrokeWidth = 1;
...
//    }
     ...
     * @param circleNoCheckedColor      内部小圆未被选中的颜色
     */
    public void setSmallCircleModel(int strokeLineColor, int strokeCheckedSolidColor, int strokeNoCheckedSolidColor, int circleCheckedColor, int circleNoCheckedColor) {
        isBigCircle = false;
        strokeLineColor_int = strokeLineColor;
...
//        canvas.drawRoundRect(PADDING, PADDING, mWidth - PADDING, mHeight - PADDING, strokeCircleRadius, strokeCircleRadius, mPaint);
        canvas.drawRoundRect(new RectF(PADDING, PADDING, mWidth - PADDING, mHeight - PADDING), strokeCircleRadius, strokeCircleRadius, mPaint);
